...
let handler = async (m, { conn, text, usedPrefix, command, args, participants, isOwner }) => {
  ...
  if (!args[0]) throw m.reply(`✳️ Envie el link del Grupo\n\n 📌 Ejemplo:\n *${usedPrefix + command}* <linkwa> <dias>\n\n_el número son los días que el bot estará en el grupo_`, m, rcanal)
  if (!code) throw m.reply(`✳️ Link inválido`, m, rcanal)
