...
if (!text) throw m.reply(`✳️ ${mssg.notext}`);
m.react('💬')

 let syst = `Eres Hajime Bot, un gran modelo de lenguaje entrenado por OpenAI. Siga cuidadosamente las instrucciones del usuario. Responde usando Markdown.`
	try {
