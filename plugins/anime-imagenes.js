  ...
  try {
    ...
    const results = await Promise.all(images.map(async (imageUrl, index) => {
      ...
      return {
        ...
        footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: '*[HAJIME-ULTRA BY CUERVO-TEAM-SUPREME]*' }),
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.fromObject({
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "_\`A\` \`N\` \`I\` \`M\` \`E\` - \`H\` \`A\` \`J\` \`I\` \`M\` \`E\`_"
            }),
            ...
            contextInfo: {
									...
									forwardedNewsletterMessageInfo: {
										newsletterJid: "120363266403694976@newsletter",
										newsletterName: "H̷࣮ᰮA̷̸֧JࣲؚׅIׅM̷̿E̶꯭ B̷͡O̷͡꙱T̷ U̷̸ࣲḺ̶̨̻̃͑̕͠T̷̸⃜᪾ۣܻؕ͋R̷͡A̸̷̶",
										serverMessageId: 143
									}
								}
          })
