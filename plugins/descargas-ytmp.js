...
*⇄ㅤ     ◁   ㅤ  ❚❚ㅤ     ▷ㅤ     ↻*
*Descargado el audio en documento, aguarden un momento por favor....*`.trim();
...
const texto1 = `${yt_play[0].title}
*⇄ㅤ     ◁   ㅤ  ❚❚ㅤ     ▷ㅤ     ↻*
*Descargado el vídeo en documento, aguarden un momento por favor....*`.trim();
...
if (command == 'ytmax') {
if (!text) return conn.reply(m.chat, `*Que esta buscado?*\n*Ingrese el nombre del la canción*`, m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '', previewType: 0, thumbnail: fglog, sourceUrl: fgcanal}}})
const yt_play = await search(args.join(' '))
...
handler.help = ['ytmp3', 'ytmp4', 'ytmp3doc', 'ytmp4doc', 'playdoc', 'playdoc2', 'ytmax'];
handler.tags = ['dl'];
handler.command = ['ytmp3', 'ytmp4', 'ytmp3doc', 'ytmp4doc', 'playdoc', 'playdoc2', 'ytmax'];
