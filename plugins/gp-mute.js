...
const handler = async (_0x5b04ea, {
  ...
  if (_0x38ad25 === "mute") {
    ...
    if (_0x5b04ea.mentionedJid[0x0] === _0x45f556) {
      throw "🚩 *El creador del bot no puede ser muteado*";
    }
    ...
    if (_0x5b04ea.mentionedJid[0x0] === _0x69b64a) {
      throw "🚩 *No puedes mutear el creador del grupo*";
    }
    ...
    if (!_0x5b04ea.mentionedJid[0x0] && !_0x5b04ea.quoted) {
      return _0x24d45b.reply(_0x5b04ea.chat, "🚩 *Menciona a la persona que deseas mutear*", _0x5b04ea);
    }
    if (_0xc6ae1d.muto === true) {
      throw "🚩 *Este usuario ya ha sido muteado*";
    }
    ...
    if (_0x38ad25 === "unmute") {
      ...
      if (_0x12128f === _0x5b04ea.sender) {
        throw "🚩 *Sólo otro administrador puede desmutearte*";
      }
      if (!_0x5b04ea.mentionedJid[0x0] && !_0x5b04ea.quoted) {
        return _0x24d45b.reply(_0x5b04ea.chat, "🚩 *Menciona a la persona que deseas desmutear*", _0x5b04ea);
      }
      if (_0x498844.muto === false) {
        throw "🚩 *Este usuario no ha sido muteado*";
      }
